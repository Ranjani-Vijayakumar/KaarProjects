...
con_string = "mongodb+srv://Ranjani:ranjanivijay23@cluster0.kp86ykr.mongodb.net/?retryWrites=true&w=majority"
client = MongoClient(con_string )
db = client.get_database('Ranjanidb')
user_collection = pymongo.collection.Collection(db, 'Ranjani') 
...
def project_api_routes(endpoints):
    ...
    def connection():
            str = "Welcome to Ranjani's API"
            print("Welcome to Ranjani's API")
            return str
